...
#ifndef _REG
#define _REG(name) { #name, __lua_ray_##name }
#endif
...
static luaL_Reg const __lua_lay_core_window[] = {
        // Window-related functions
        _REG(InitWindow),
        _REG(WindowShouldClose),
        _REG(CloseWindow),
        _REG(IsWindowReady),
        _REG(IsWindowMinimized),
        _REG(IsWindowResized),
        _REG(IsWindowHidden),
        _REG(ToggleFullscreen),
        _REG(UnhideWindow),
        _REG(HideWindow),
        _REG(SetWindowIcon),
        _REG(SetWindowTitle),
        _REG(SetWindowPosition),
        _REG(SetWindowMonitor),
        _REG(SetWindowMinSize),
        _REG(SetWindowSize),
        _REG(GetScreenWidth),
        _REG(GetScreenHeight),
        _REG(GetMonitorCount),
        _REG(GetMonitorWidth),
        _REG(GetMonitorHeight),
        _REG(GetMonitorPhysicalWidth),
        _REG(GetMonitorPhysicalHeight),
        _REG(GetMonitorName),
        _REG(GetClipboardText),
        _REG(SetClipboardText),
        ...
        //_REG(BeginMode3D),
        //_REG(EndMode3D),
        //_REG(BeginTextureMode),
        //_REG(EndTextureMode),
        // Screen-space-related functions
        //_REG(GetMouseRay),
        //_REG(GetWorldToScreen),
        //_REG(GetCameraMatrix),
...
bool luaopen_raylib(lua_State * L)
{
    char const * const LIB_NAME = "ray";
    luaL_openlib(L, LIB_NAME, __lua_lay_core_window, 0);
    return true;
}

char const * const get_basic_window_lua(lua_State * L) TBAG_NOEXCEPT
{
    return R"(-- Core - Basic window

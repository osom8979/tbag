...
#define RAY_COLOR_SYMBOL(L, s, r, g, b, a)      \
    do {                                        \
        luaL_pushcolor(L, Color{r, g, b, a});   \
        lua_setfield(L, -2, #s);                \
    } while (false) /* -- END -- */
#endif
...
void luaL_push_raygui_symbols(lua_State * L)
{
    RAY_INT_SYMBOL(L, GUI_STATE_NORMAL);
    RAY_INT_SYMBOL(L, GUI_STATE_FOCUSED);
    RAY_INT_SYMBOL(L, GUI_STATE_PRESSED);
    RAY_INT_SYMBOL(L, GUI_STATE_DISABLED);
    RAY_INT_SYMBOL(L, GUI_TEXT_ALIGN_LEFT);
    RAY_INT_SYMBOL(L, GUI_TEXT_ALIGN_CENTER);
    RAY_INT_SYMBOL(L, GUI_TEXT_ALIGN_RIGHT);
    RAY_INT_SYMBOL(L, DEFAULT);
    RAY_INT_SYMBOL(L, LABEL);
    RAY_INT_SYMBOL(L, BUTTON);
    RAY_INT_SYMBOL(L, TOGGLE);
    RAY_INT_SYMBOL(L, SLIDER);
    RAY_INT_SYMBOL(L, PROGRESSBAR);
    RAY_INT_SYMBOL(L, CHECKBOX);
    RAY_INT_SYMBOL(L, COMBOBOX);
    RAY_INT_SYMBOL(L, DROPDOWNBOX);
    RAY_INT_SYMBOL(L, TEXTBOX);
    RAY_INT_SYMBOL(L, LISTVIEW);
    RAY_INT_SYMBOL(L, COLORPICKER);
    RAY_INT_SYMBOL(L, SCROLLBAR);
    RAY_INT_SYMBOL(L, BORDER_COLOR_NORMAL);
    RAY_INT_SYMBOL(L, BASE_COLOR_NORMAL);
    RAY_INT_SYMBOL(L, TEXT_COLOR_NORMAL);
    RAY_INT_SYMBOL(L, BORDER_COLOR_FOCUSED);
    RAY_INT_SYMBOL(L, BASE_COLOR_FOCUSED);
    RAY_INT_SYMBOL(L, TEXT_COLOR_FOCUSED);
    RAY_INT_SYMBOL(L, BORDER_COLOR_PRESSED);
    RAY_INT_SYMBOL(L, BASE_COLOR_PRESSED);
    RAY_INT_SYMBOL(L, TEXT_COLOR_PRESSED);
    RAY_INT_SYMBOL(L, BORDER_COLOR_DISABLED);
    RAY_INT_SYMBOL(L, BASE_COLOR_DISABLED);
    RAY_INT_SYMBOL(L, TEXT_COLOR_DISABLED);
    RAY_INT_SYMBOL(L, BORDER_WIDTH);
    RAY_INT_SYMBOL(L, INNER_PADDING);
    RAY_INT_SYMBOL(L, TEXT_ALIGNMENT);
    RAY_INT_SYMBOL(L, RESERVED02);
    RAY_INT_SYMBOL(L, TEXT_SIZE);
    RAY_INT_SYMBOL(L, TEXT_SPACING);
    RAY_INT_SYMBOL(L, LINE_COLOR);
    RAY_INT_SYMBOL(L, BACKGROUND_COLOR);
    RAY_INT_SYMBOL(L, GROUP_PADDING);
    RAY_INT_SYMBOL(L, SLIDER_WIDTH);
    RAY_INT_SYMBOL(L, TEXT_PADDING);
    RAY_INT_SYMBOL(L, MULTILINE_PADDING);
    RAY_INT_SYMBOL(L, SPINNER_BUTTON_WIDTH);
    RAY_INT_SYMBOL(L, SPINNER_BUTTON_PADDING);
    RAY_INT_SYMBOL(L, SPINNER_BUTTON_BORDER_WIDTH);
    RAY_INT_SYMBOL(L, CHECK_TEXT_PADDING);
    RAY_INT_SYMBOL(L, SELECTOR_WIDTH);
    RAY_INT_SYMBOL(L, SELECTOR_PADDING);
    RAY_INT_SYMBOL(L, ARROW_RIGHT_PADDING);
    RAY_INT_SYMBOL(L, COLOR_SELECTOR_SIZE);
    RAY_INT_SYMBOL(L, BAR_WIDTH);
    RAY_INT_SYMBOL(L, BAR_PADDING);
    RAY_INT_SYMBOL(L, BAR_SELECTOR_HEIGHT);
    RAY_INT_SYMBOL(L, BAR_SELECTOR_PADDING);
    RAY_INT_SYMBOL(L, ELEMENTS_HEIGHT);
    RAY_INT_SYMBOL(L, ELEMENTS_PADDING);
    RAY_INT_SYMBOL(L, SCROLLBAR_WIDTH);
    RAY_INT_SYMBOL(L, SCROLLBAR_SIDE);
    RAY_INT_SYMBOL(L, SCROLLBAR_BORDER);
    RAY_INT_SYMBOL(L, SCROLLBAR_SHOW_SPINNER_BUTTONS);
    RAY_INT_SYMBOL(L, SCROLLBAR_ARROWS_SIZE);
    RAY_INT_SYMBOL(L, SCROLLBAR_PADDING);
    RAY_INT_SYMBOL(L, SCROLLBAR_SLIDER_PADDING);
    RAY_INT_SYMBOL(L, SCROLLBAR_SLIDER_SIZE);
    RAY_INT_SYMBOL(L, SCROLLBAR_SCROLL_SPEED);
    RAY_INT_SYMBOL(L, SCROLLBAR_LEFT_SIDE);
    RAY_INT_SYMBOL(L, SCROLLBAR_RIGHT_SIDE);
}

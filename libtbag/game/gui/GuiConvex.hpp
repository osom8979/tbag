/**
 * @file   GuiConvex.hpp
 * @brief  GuiConvex class prototype.
 * @author zer0
 * @date   2019-04-07
 */

#ifndef __INCLUDE_LIBTBAG__LIBTBAG_GAME_GUI_GUICONVEX_HPP__
#define __INCLUDE_LIBTBAG__LIBTBAG_GAME_GUI_GUICONVEX_HPP__
...
/**
 * GuiConvex class prototype.
 *
 * @author zer0
 * @date   2019-04-07
 */
class TBAG_API GuiConvex : public GameCommonTypes
{
public:
    struct Impl;
    friend struct Impl;
...
public:
    GuiConvex();
    GuiConvex(std::nullptr_t) TBAG_NOEXCEPT;
    GuiConvex(GuiConvex const & obj) TBAG_NOEXCEPT;
    GuiConvex(GuiConvex && obj) TBAG_NOEXCEPT;
    ~GuiConvex();

public:
    GuiConvex & operator =(GuiConvex const & obj) TBAG_NOEXCEPT;
    GuiConvex & operator =(GuiConvex && obj) TBAG_NOEXCEPT;

public:
    void copy(GuiConvex const & obj) TBAG_NOEXCEPT;
    void swap(GuiConvex & obj) TBAG_NOEXCEPT;

public:
    inline friend void swap(GuiConvex & lh, GuiConvex & rh) TBAG_NOEXCEPT
    { lh.swap(rh); }
...
public:
    friend inline bool operator <(GuiConvex const & x, GuiConvex const & y) TBAG_NOEXCEPT
    { return x.get() < y.get(); }
    ...
    inline bool operator ==(GuiConvex const & obj) const TBAG_NOEXCEPT
    { return get() == obj.get(); }
...
public:
    ...
    void getPoint(std::size_t index, float * x, float * y) const;
...
public:
    void setPoint(std::size_t index, Point2f const & pos);
    Point2f getPoint(std::size_t index) const;
};
...
#endif // __INCLUDE_LIBTBAG__LIBTBAG_GAME_GUI_GUICONVEX_HPP__

...
TBAG_CONSTEXPR btype const BT_NONE    = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_UNKNOWN , _BOX_TYPE_SIZE_0BIT  );
TBAG_CONSTEXPR btype const BT_INT8    = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_SIGNED  , _BOX_TYPE_SIZE_8BIT  );
TBAG_CONSTEXPR btype const BT_INT16   = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_SIGNED  , _BOX_TYPE_SIZE_16BIT );
TBAG_CONSTEXPR btype const BT_INT32   = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_SIGNED  , _BOX_TYPE_SIZE_32BIT );
TBAG_CONSTEXPR btype const BT_INT64   = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_SIGNED  , _BOX_TYPE_SIZE_64BIT );
TBAG_CONSTEXPR btype const BT_UINT8   = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_UNSIGNED, _BOX_TYPE_SIZE_8BIT  );
TBAG_CONSTEXPR btype const BT_UINT16  = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_UNSIGNED, _BOX_TYPE_SIZE_16BIT );
TBAG_CONSTEXPR btype const BT_UINT32  = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_UNSIGNED, _BOX_TYPE_SIZE_32BIT );
TBAG_CONSTEXPR btype const BT_UINT64  = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_UNSIGNED, _BOX_TYPE_SIZE_64BIT );
TBAG_CONSTEXPR btype const BT_FLOAT32 = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_FLOATING, _BOX_TYPE_SIZE_32BIT );
TBAG_CONSTEXPR btype const BT_FLOAT64 = MAKE_BOX_TYPE(_BOX_TYPE_PREFIX_FLOATING, _BOX_TYPE_SIZE_64BIT );

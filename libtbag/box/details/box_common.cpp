...
bool box_support_type(btype type) TBAG_NOEXCEPT
{
    ...
    case BOX_TYPE_COMPLEX64:  return true;
    case BOX_TYPE_COMPLEX128: return true;
...
char const * const box_get_type_name(btype type) TBAG_NOEXCEPT
{
    ...
    case BOX_TYPE_COMPLEX64:  return "COMPLEX64";
    case BOX_TYPE_COMPLEX128: return "COMPLEX128";
...
ui32 box_get_type_byte(btype type) TBAG_NOEXCEPT
{
    ...
    case BOX_TYPE_COMPLEX64:  return sizeof(cp64);
    case BOX_TYPE_COMPLEX128: return sizeof(cp128);
    default:                  return 0;
    }
    // @formatter:on
}

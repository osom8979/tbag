                          ...
                          ui32 size) TBAG_NOEXCEPT
{
    ...
    case BT_COMPLEX64:  box_cpu_element_copy_impl((c64  *)src, size, dest, dest_type); break;
    case BT_COMPLEX128: box_cpu_element_copy_impl((c128 *)src, size, dest, dest_type); break;
    case BT_NONE:
        TBAG_FALLTHROUGH
    default:
                 ...
                 void const * TBAG_RESTRICT src, btype src_type) TBAG_NOEXCEPT
{
    ...
    case BT_COMPLEX64:  box_cpu_set_impl((c64  *)src, dest, dest_type); break;
    case BT_COMPLEX128: box_cpu_set_impl((c128 *)src, dest, dest_type); break;
    case BT_NONE:
        TBAG_FALLTHROUGH
    default:
        TBAG_INACCESSIBLE_BLOCK_ASSERT();
...
bool box_cpu_all(void const * data, btype type, ui32 size)
{
    ...
    case BT_COMPLEX64:  return box_cpu_all_impl((c64  const *)data, size);
    case BT_COMPLEX128: return box_cpu_all_impl((c128 const *)data, size);
    case BT_NONE:
        TBAG_FALLTHROUGH
    default:
        TBAG_INACCESSIBLE_BLOCK_ASSERT();
...
bool box_cpu_any(void const * data, btype type, ui32 size)
{
    ...
    case BT_COMPLEX64:  return box_cpu_any_impl((c64  const *)data, size);
    case BT_COMPLEX128: return box_cpu_any_impl((c128 const *)data, size);
    case BT_NONE:
        TBAG_FALLTHROUGH
    default:
        TBAG_INACCESSIBLE_BLOCK_ASSERT();
...
std::size_t box_cpu_count(void const * data, btype type, ui32 size)
{
    ...
    case BT_COMPLEX64:  return box_cpu_count_impl((c64  const *)data, size);
    case BT_COMPLEX128: return box_cpu_count_impl((c128 const *)data, size);
    case BT_NONE:
        TBAG_FALLTHROUGH
    default:
        TBAG_INACCESSIBLE_BLOCK_ASSERT();

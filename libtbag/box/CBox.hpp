...
TBAG_CONSTEXPR btype const BT_BOOL       = MAKE_BOX_TYPE(BOX_TYPE_PREFIX_BOOLEAN , BOX_TYPE_SIZE_1BIT  ); // UNSUPPORTED
...
TBAG_CONSTEXPR btype const BT_COMPLEX64  = MAKE_BOX_TYPE(BOX_TYPE_PREFIX_COMPLEX , BOX_TYPE_SIZE_64BIT ); // UNSUPPORTED
TBAG_CONSTEXPR btype const BT_COMPLEX128 = MAKE_BOX_TYPE(BOX_TYPE_PREFIX_COMPLEX , BOX_TYPE_SIZE_128BIT); // UNSUPPORTED

...
UxIdle::UxIdle() : UxHandle()
{
    // EMPTY.
}

UxIdle::UxIdle(UxLoop & loop) : UxHandle()
{
...
UxIdle::UxIdle(UxIdle const & obj) TBAG_NOEXCEPT : UxIdle()
{
    (*this) = obj;
}

UxIdle::UxIdle(UxIdle && obj) TBAG_NOEXCEPT : UxIdle()
{
    (*this) = std::move(obj);
}

...
TBAG_API int tbCudaAdd1f(float  const * gpu_v1, float  const * gpu_v2, float  * gpu_result, int size, void * stream = 0);
TBAG_API int tbCudaAdd1d(double const * gpu_v1, double const * gpu_v2, double * gpu_result, int size, void * stream = 0);

...
std::string toUpperByteText(std::size_t byte)
{
    ...
    if (byte >= YOTTA_BYTE_TO_BYTE) {
        return std::to_string(byte/YOTTA_BYTE_TO_BYTE) + YOTTA_BYTE_LOWER_CHAR;
    } else if (byte >= ZETTA_BYTE_TO_BYTE) {
        return std::to_string(byte/ZETTA_BYTE_TO_BYTE) + ZETTA_BYTE_LOWER_CHAR;
    } else
#endif

    if (byte >= EXA_BYTE_TO_BYTE) {
        return std::to_string(byte/EXA_BYTE_TO_BYTE) + EXA_BYTE_LOWER_CHAR;
    } else if (byte >= PETA_BYTE_TO_BYTE) {
        return std::to_string(byte/PETA_BYTE_TO_BYTE) + PETA_BYTE_LOWER_CHAR;
    } else if (byte >= TERA_BYTE_TO_BYTE) {
        return std::to_string(byte/TERA_BYTE_TO_BYTE) + TERA_BYTE_LOWER_CHAR;
    } else if (byte >= GIGA_BYTE_TO_BYTE) {
        return std::to_string(byte/GIGA_BYTE_TO_BYTE) + GIGA_BYTE_LOWER_CHAR;
    } else if (byte >= MEGA_BYTE_TO_BYTE) {
        return std::to_string(byte/MEGA_BYTE_TO_BYTE) + MEGA_BYTE_LOWER_CHAR;
    } else if (byte >= KILO_BYTE_TO_BYTE) {
        return std::to_string(byte/KILO_BYTE_TO_BYTE) + KILO_BYTE_LOWER_CHAR;
    } else {
        return std::to_string(byte) + BYTE_LOWER_CHAR;
    }
}

...
public:
    HttpClient(std::string const & uri, bool use_websocket = false);
    HttpClient(std::string const & uri, std::string const & key, bool use_websocket = false);
    HttpClient(MqParams const & params, bool use_websocket = false);
    HttpClient(MqParams const & params, std::string const & key, bool use_websocket = false);
    ~HttpClient();

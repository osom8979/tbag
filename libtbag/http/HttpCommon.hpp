...
#define TBAG_HTTP_COMMON_STR_SP   " "
#define TBAG_HTTP_COMMON_STR_HT   "\t"
#define TBAG_HTTP_COMMON_STR_CR   "\r"
#define TBAG_HTTP_COMMON_STR_LF   "\n"
#define TBAG_HTTP_COMMON_STR_CRLF TBAG_HTTP_COMMON_STR_CR TBAG_HTTP_COMMON_STR_LF

#define TBAG_HTTP_COMMON_STR_EMPTY_CONTENT_HEADERS \
    "Content-Type: text/plain" TBAG_HTTP_COMMON_STR_CRLF \
    "Content-Length: 0" TBAG_HTTP_COMMON_STR_CRLF

#define TBAG_HTTP_COMMON_STR_EMPTY_CONTENT_200 \
    "HTTP/1.1 200 Ok" TBAG_HTTP_COMMON_STR_CRLF \
    TBAG_HTTP_COMMON_STR_EMPTY_CONTENT_HEADERS \
    TBAG_HTTP_COMMON_STR_CRLF
#define TBAG_HTTP_COMMON_STR_EMPTY_CONTENT_400 \
    "HTTP/1.1 400 Bad Request" TBAG_HTTP_COMMON_STR_CRLF \
    TBAG_HTTP_COMMON_STR_EMPTY_CONTENT_HEADERS \
    TBAG_HTTP_COMMON_STR_CRLF
#define TBAG_HTTP_COMMON_STR_EMPTY_CONTENT_406 \
    "HTTP/1.1 406 Not Acceptable" TBAG_HTTP_COMMON_STR_CRLF \
    TBAG_HTTP_COMMON_STR_EMPTY_CONTENT_HEADERS \
    TBAG_HTTP_COMMON_STR_CRLF
#define TBAG_HTTP_COMMON_STR_EMPTY_CONTENT_412 \
    "HTTP/1.1 412 Precondition Failed" TBAG_HTTP_COMMON_STR_CRLF \
    TBAG_HTTP_COMMON_STR_EMPTY_CONTENT_HEADERS \
    TBAG_HTTP_COMMON_STR_CRLF
...
TBAG_CONSTEXPR char const * const   SP = TBAG_HTTP_COMMON_STR_SP;
TBAG_CONSTEXPR char const * const   HT = TBAG_HTTP_COMMON_STR_HT;
TBAG_CONSTEXPR char const * const   CR = TBAG_HTTP_COMMON_STR_CR;
TBAG_CONSTEXPR char const * const   LF = TBAG_HTTP_COMMON_STR_LF;
TBAG_CONSTEXPR char const * const CRLF = TBAG_HTTP_COMMON_STR_CRLF;

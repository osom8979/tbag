...
public:
    ...
    using OnWsMessage = std::function<void(ws::WsOpCode, char const *, std::size_t)>;
...
protected:
    ...
    virtual void onWsMessage(ws::WsOpCode op, char const * buffer, std::size_t size) override
    {

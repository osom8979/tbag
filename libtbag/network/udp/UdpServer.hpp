...
public:
    inline bool emptySenders() const TBAG_NOEXCEPT_EXPR(TBAG_NOEXCEPT_EXPR(_senders.empty()))
    { Guard g(_mutex); return _senders.empty(); }
    inline std::size_t sizeSenders() const TBAG_NOEXCEPT_EXPR(TBAG_NOEXCEPT_EXPR(_senders.size()))

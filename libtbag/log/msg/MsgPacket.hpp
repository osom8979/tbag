...
public:
    // @formatter:off
    inline char const * c_str() const TBAG_NOEXCEPT_EXPR(TBAG_NOEXCEPT_EXPR(_message.c_str()))
    { return _message.c_str(); }
    inline bool empty() const TBAG_NOEXCEPT_EXPR(TBAG_NOEXCEPT_EXPR(_message.empty()))
    { return _message.empty(); }
    inline std::size_t size() const TBAG_NOEXCEPT_EXPR(TBAG_NOEXCEPT_EXPR(_message.size()))
    { return _message.size(); }
    inline void clear() TBAG_NOEXCEPT_EXPR(TBAG_NOEXCEPT_EXPR(_message.clear()))
    { _message.clear(); }
    // @formatter:on

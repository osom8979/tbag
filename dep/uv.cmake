...
add_custom_command (
        ...
        COMMAND ./autogen.sh &> "${TBAG_DEP_UV_LOG_PREFIX}.1"
...
add_custom_command (
        ...
        COMMAND ./configure --disable-shared --enable-static &> "${TBAG_DEP_UV_LOG_PREFIX}.2"
...
add_custom_command (
        ...
        COMMAND make &> "${TBAG_DEP_UV_LOG_PREFIX}.3"

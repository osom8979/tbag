...
struct AddKernelTest
{
    ...
    AddKernelTest(GpuBackendType t, std::size_t c) : gpu(createGpuContext(t)), count(c)
    {
...
TEST(AddTestFixture, Cpu)
{
    std::size_t const TEST_COUNT = 99;
    AddKernelTest tester(GpuBackendType::GBT_CPU, TEST_COUNT);

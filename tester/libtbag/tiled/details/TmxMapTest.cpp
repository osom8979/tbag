 ...
 <layer name="Ground" width="20" height="20">
  <data encoding="base64" compression="zlib">
   
    ...
    ASSERT_EQ(6, map.hexside_length);
    ...
    ASSERT_EQ(1, map.tile_sets.size());
    ASSERT_EQ(1, map.tile_sets[0].tile_offsets.size());
    ASSERT_EQ(0, map.tile_sets[0].tile_offsets[0].x);
    ASSERT_EQ(1, map.tile_sets[0].tile_offsets[0].y);
    ASSERT_EQ(1, map.tile_sets[0].images.size());
    ASSERT_STREQ("hexmini.png", map.tile_sets[0].images[0].source.c_str());
    ASSERT_EQ(106, map.tile_sets[0].images[0].width);
    ASSERT_EQ(72, map.tile_sets[0].images[0].height);
    ...
    ASSERT_EQ(6, map2.hexside_length);
    ...
    ASSERT_EQ(1, map2.tile_sets.size());
    ASSERT_EQ(1, map2.tile_sets[0].tile_offsets.size());
    ASSERT_EQ(0, map2.tile_sets[0].tile_offsets[0].x);
    ASSERT_EQ(1, map2.tile_sets[0].tile_offsets[0].y);
    ASSERT_EQ(1, map2.tile_sets[0].images.size());
    ASSERT_STREQ("hexmini.png", map2.tile_sets[0].images[0].source.c_str());
    ASSERT_EQ(106, map2.tile_sets[0].images[0].width);
    ASSERT_EQ(72, map2.tile_sets[0].images[0].height);

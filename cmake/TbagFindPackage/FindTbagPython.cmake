...
macro (tabg_python__find_default)
    ...
    if (__python_interpreter AND NOT Python_Interpreter_FOUND)
        ...
        if (CMAKE_VERSION VERSION_LESS "3.12")
            find_package (PythonInterp ${TbagPython_FIND_VERSION})
            ...
            find_package (Python ${TbagPython_FIND_VERSION} COMPONENTS Interpreter)
        endif ()
    endif ()
    ...
    if (__python_development AND NOT Python_Development_FOUND)
        if (TbagPython_PYENV_NAME)
            ...
            if (CMAKE_VERSION VERSION_LESS "3.12")
                find_package (PythonLibs ${TbagPython_FIND_VERSION})
                if (PYTHONLIBS_FOUND)
                ...
                find_package (Python ${TbagPython_FIND_VERSION} COMPONENTS Development)
            endif ()
        endif ()
    endif ()
    ...
    if (__python_numpy AND NOT Python_NumPy_FOUND)
        ...
        if (CMAKE_VERSION VERSION_LESS "3.14")
            if (NOT PYTHONINTERP_FOUND AND Python_Interpreter_FOUND)
